...
/**
 * Removes hash from strings like filename.addition.<hash-goes-here>.css
 */
ManifestPlugin.prototype.removeHash = str => str.replace(/(.+\..+)(\..+)(\..+)$/i, '$1$3');
    ...
    _.merge(manifest, compilation.chunks.reduce(function(memo, chunk) {
      ...
      return chunk.files.reduce(function(memo, file) {
        ...
        if (chunkName) {
          ...
          memo[this.removeHash(file)] = file;
        } else {
          memo[file] = file;
        }
        return memo;
